...
const DEALS = [
  ...
  },
  {
    ...
    category: "Бытовая техника",
    brand: "Nocord",
    name: "Мойка Nocord, 1800Вт, 140 бар, 420 л/час, грязевая фреза, пеногенератор 600 мл, кабель 5 м, шланг 6 м, колёса, NPW-1800.140.420.O",
    image: "https://cdn.poehali.dev/projects/3cc554dd-dac0-40af-b0e6-a124251b0aa4/bucket/ade17b87-86af-44ef-96b0-9cc8beba50aa.png",
    originalPrice: 10190,
    salePrice: 7240,
    discount: 29,
    rating: 4.8,
    ...
    badgeColor: "bg-[hsl(var(--deal-red))] text-white",
    validUntil: "18 мая",
    yandexReview: "Отмыл машину, забор и террасу — справилась на ура. 140 бар давление, шланг длинный, колёса удобные. Пеногенератор в комплекте — бонус.",
    reviewAuthor: "Николай С.",
    reviewStars: 5,
    link: "https://market.yandex.ru/cc/9N8ZFt",
  },
  {
    id: 20,
    category: "Электроника",
    brand: "HONOR",
    name: "Смартфон HONOR 400 12+256ГБ, Космический серый, 5G, камера 200 Мп, батарея 6000 мАч, 6.55\"",
    image: "https://cdn.poehali.dev/projects/3cc554dd-dac0-40af-b0e6-a124251b0aa4/bucket/31554883-ca8b-49ad-b403-fef2fe6b8dac.png",
    originalPrice: 40305,
    salePrice: 36132,
    discount: 10,
    rating: 4.9,
    ...
    badgeColor: "bg-[hsl(var(--deal-red))] text-white",
    validUntil: "18 мая",
    yandexReview: "Камера 200 Мп снимает просто отлично, даже ночью. Батарея 6000 мАч — два дня без зарядки легко. 5G, 12+256 ГБ — полный флагман за вменяемые деньги.",
    reviewAuthor: "Павел К.",
    reviewStars: 5,
    link: "https://market.yandex.ru/cc/9N8buA",
  },
  {
    id: 21,
    category: "Бытовая техника",
    brand: "Kitfort",
    name: "Аэрогриль Kitfort KT-8110, двойная чаша 8.6 л, 2700 Вт, таймер, электронное управление",
    image: "https://cdn.poehali.dev/projects/3cc554dd-dac0-40af-b0e6-a124251b0aa4/bucket/64b3d6a8-508c-4f0e-ad50-aef45256bfdc.png",
    originalPrice: 14590,
    salePrice: 10770,
    discount: 26,
    rating: 4.8,
    ...
    badgeColor: "bg-[hsl(var(--deal-red))] text-white",
    validUntil: "18 мая",
    yandexReview: "Две корзины — готовлю одновременно курицу и картошку. 2700 Вт, всё быстро и равномерно. Стекло спереди видно что происходит. Kitfort — качество проверенное.",
    reviewAuthor: "Ольга М.",
    reviewStars: 5,
    link: "https://market.yandex.ru/cc/9N8iXD",
  },
  {
    id: 22,
    category: "Инструменты",
    brand: "Boxbot",
    name: "Аккумуляторная УШМ Boxbot 20В, диск 125 мм, бесщёточный двигатель, 2 АКБ 4.0 А/ч, в кейсе, AG-20B",
    image: "https://cdn.poehali.dev/projects/3cc554dd-dac0-40af-b0e6-a124251b0aa4/bucket/749966b5-b77d-47ee-95ed-27d0d7baddd9.png",
    originalPrice: 5047,
    salePrice: 3586,
    discount: 29,
    rating: 4.7,
    ...
    badgeColor: "bg-[hsl(var(--deal-red))] text-white",
    validUntil: "18 мая",
    yandexReview: "Два аккумулятора в комплекте — работаю весь день без перерыва. Бесщёточный мотор мощный, в кейсе удобно хранить. За такую цену — просто находка.",
    reviewAuthor: "Владимир Т.",
    reviewStars: 5,
    link: "https://market.yandex.ru/cc/9N8q78",
  },
  {
    id: 23,
    category: "Инструменты",
    brand: "Vniissok",
    name: "Сварочный инвертор полуавтомат Vniissok MIG-200, 3 в 1 (MMA/MIG NO GAS/TIG), IGBT, 20-200А, проволока в комплекте",
    image: "https://cdn.poehali.dev/projects/3cc554dd-dac0-40af-b0e6-a124251b0aa4/bucket/df2bf732-2ca2-4625-af94-2c2e829d3f0a.png",
    originalPrice: 19700,
    salePrice: 6702,
    discount: 66,
    rating: 4.8,
    ...
    badgeColor: "bg-[hsl(var(--deal-red))] text-white",
    validUntil: "18 мая",
    yandexReview: "Три режима в одном — MIG, MMA и TIG. Проволока в комплекте, сразу можно работать. Шов ровный, аппарат лёгкий. За такую цену — лучшее что есть.",
    reviewAuthor: "Евгений Д.",
    reviewStars: 5,
    link: "https://market.yandex.ru/cc/9N8rqJ",
  },
  {
    id: 11,
    category: "Бытовая техника",
